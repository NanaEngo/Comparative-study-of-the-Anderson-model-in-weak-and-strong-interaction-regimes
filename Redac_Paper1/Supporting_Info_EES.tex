...
%=============================================================================
\section{Process Tensor-HOPS framework}\label{si:pthops}
%=============================================================================

Simulations employ the Process Tensor-HOPS (PT-HOPS) method to approximate the non-Markovian open quantum system dynamics. This section details the method and benchmarks its performance against HEOM and Redfield theory.
