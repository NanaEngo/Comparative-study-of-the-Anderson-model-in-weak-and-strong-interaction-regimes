...
\begin{enumerate}
    \item \textbf{Molecular Scale.} FMO and other small complexes with full quantum dynamics (current capability: \numrange{10}{100} chromophores)
    \item \textbf{Supramolecular Scale.} Antenna complexes with reduced models (current capability: \numrange{100}{1000} chromophores with SBD)
    \item \textbf{Organelle Scale.} Complete chloroplast with coarse-grained models (target: \num{1000}+ chromophores)
...
For high-value specialty crops (USD~\numrange{15000}{25000}\,\si{\per\hectare} baseline), quantum advantages yield USD~\numrange{1500}{3000} additional annual revenue, enabling agrivoltaics in premium agricultural markets.
