...
Unlike Markovian approximations (Lindblad, Redfield) that assume instantaneous environmental relaxation, non-Markovian treatment preserves structured bath fluctuations that enhance energy transfer efficiency under engineered spectral conditions \cite{Scholes2017, Cianci2017, Sabin2021}.
...
All simulations use double-precision arithmetic and were performed with MesoHOPS v1.2.0 on an AMD Ryzen 5 5500U processor with 8 cores and 4 threads, \SI{38}{\giga\byte} of RAM, and AMD Radeon Graphics GPU.
