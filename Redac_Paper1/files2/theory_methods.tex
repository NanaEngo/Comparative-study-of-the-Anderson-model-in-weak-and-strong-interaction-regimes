...
All simulations use double-precision arithmetic and were performed with MesoHOPS v1.2.0 on 32-core AMD EPYC processors. A typical FMO simulation (7 chromophores, \SI{100}{\pico\second} dynamics) requires approximately 4~hours per node.
